...
public class Constants {
    ...
    public static final int IMPLICIT_WAIT = 10; // declaring implicit wait for 10 sec
    public static final int EXPLICIT_WAIT = 20; // declaring explicit wait for 20 sec
